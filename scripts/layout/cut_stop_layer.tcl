proc cut_stop_layer {args} {
   ...
   parse_proc_arguments -args $args results
	...
	cut_view_setting_stop_layer $min_layer $max_layer 0
	...
	cut_view_setting_stop_layer $min_layer $max_layer 1
	deselect_obj -all

}


define_proc_arguments cut_stop_layer \
...
proc cut_view_setting_stop_layer {min_layer max_layer onoff} {
...
set_layer_preference M${max_layer} -is_visible 1
