...
proc place_pins {scheme layers edge offset_start offset_end direction} {
  global pinsList
  ...
  foreach pin $pinsList {
    ...
    puts $loc
    edit_pin -pin $pin -layer [lindex $layers [expr $i % $nbr_layers]] -assign $loc -fix_overlap 0 -fixed_pin 1
    incr i
  }
