...
source -e -v /space/users/ory/user/be_scripts/nxt_007_tools/grid_cluster/macro_placement.tcl
...
source /space/users/ory/wb_flow/grid_cluster_2020_10_07_from_central_release/inter/grid_cluster_guides.tcl
...
# Place ports
source /space/users/ory/wb_flow/grid_cluster_2020_10_07_from_central_release/inter/grid_cluster_place_pins_ww42.tcl

check_drc -limit 100000

#write_def -floorplan -no_std_cells out/grid_cluster_floorplan.def.gz
#write_def -floorplan -no_std_cells ../inter/grid_cluster_floorplan_2020_10_19.def.gz

write_def -floorplan -no_std_cells out/${g_design}_floorplan.def.gz
write_def -floorplan -no_std_cells out/${g_design}_floorplan_[clock format [clock seconds] -format %Y%m%d_%H%M].def

write_floorplan out/${g_design}_floorplan.fp.gz

write_db -verilog      out/grid_cluster.FP.enc.dat
write_def -routing     out/grid_cluster.FP.def.gz
#exit
