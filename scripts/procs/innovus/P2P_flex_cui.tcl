...
if {[info exists options(-help)          ]} {    puts "-H- Uses the Flex Htree engine to connect a root point to any number of loads/sinks that are on the same net. \n-H- The connection will be at the desired layers, NDR and shield, also a repeater of a predefined lib cell (buffer or inverter) will be inserted on a predefined distance. \n-H- The final result will be a fully routed and fixed structure that will persist throughout the flow."  ; return   }
