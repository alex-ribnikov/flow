#start_record
#
## Via Pillar is coming from: /bespace/users/ory/nextflow_quad_1121/be_work/brcm5/grid_clusters_wrap/v0/pnr_w_blocks/scripts_local/my_vp.lef
#
##Bring clock to center of block
#proc bring_clock_port_to_center { center } {
#    set repeater_prefix   "top_source_clock_rpt"
#    set repeater_template F6UNAA_LPDSINVGT5X96
#    set repeater_distance 1000
#    set clock_source_loc  $center
...
#
#    set total_dist [expr [lindex $clock_source_loc 1] - [lindex $clock_port_location 1]]
#    set number     [expr int(floor($total_dist/$repeater_distance))]
#
...
#
#    eco_add_repeater -cells $repeater_template -name clock_tree_source    -pins [get_db $clock_port .name] -location $clock_source_loc
#    eco_add_repeater -cells $repeater_template -name ${repeater_prefix}_0 -pins [get_db $clock_port .name] -location $clock_port_rpt_location
#
#    set pin0 [get_db pins ${repeater_prefix}_0/* -if .direction==out]
#
#    set x [lindex $clock_source_loc 0]
#    for { set i $number } { $i > 0 } { incr i -1 } {
#
#        set y    [expr $i*$repeater_distance]
#        set loc  [list $x $y]
#
#        eco_add_repeater -cells $repeater_template -name ${repeater_prefix}_$i -pins [get_db $pin0 .name] -location $loc    
#    }
#
#
...
#    place_detail
#
#    set nets [get_nets -of [get_db insts *${repeater_prefix}*]]
...
#    }
#    #foreach net [get_db $nets .name] {
#    #  set_route_attributes -nets $net -top_preferred_routing_layer 18 -bottom_preferred_routing_layer 17 -route_rule NDR_F__m6_p200__m78910_p180__m11_p230__m1213_p525__m1415_p540
#    #}
#    so $nets
#    set_via_pillars -base_pin F6UNAA_LPDSINVGT5X96/o  -required 1 {MY_VP6}
