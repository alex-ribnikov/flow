...
# TODO: check if there is a cdm to delete all clk buffers
delete_inst -inst [get_db [get_db [all_fanout -from  [get_db ports grid_clk] -only_cells -flat] -if .name==*assign**] .name]
...
### OUTPUT CLOCK PORTS ###
enter_eco_mode ; # Define required set_db attributes for eco commands before each eco_* command
...
set tap_groups_list [list ck00 {*quad_west_filler_r0/grid_clk *quad_west_filler_r1/grid_clk} \
                          ...
                          ck30 {*quad_west_filler_r6/grid_clk } ]
set tap_pins_list [create_tap_groups $tap_groups_list ]
...
eco_add_repeater -cells F6UNAA_LPDSINVG3X48   -name "level_north_clock_rpt_tap_0_0" -new_net_name "level_north_clock_rpt_tap_0_0_net" -pins level_north_clock_rpt_tap_0/i -location [list $x $y]
...
eco_add_repeater -cells F6UNAA_LPDSINVG3X48   -name "level_north_clock_rpt_tap_1_1" -new_net_name "level_north_clock_rpt_tap_1_1_net" -pins level_north_clock_rpt_tap_1/i -location [list $x $y]
...
eco_add_repeater -cells F6UNAA_LPDSINVG3X48   -name "level_north_clock_rpt_tap_2_2" -new_net_name "level_north_clock_rpt_tap_2_2_net" -pins level_north_clock_rpt_tap_2/i -location [list $x $y]
...
eco_add_repeater -cells F6UNAA_LPDSINVG3X48   -name "level_north_clock_rpt_tap_3_3" -new_net_name "level_north_clock_rpt_tap_3_3_net" -pins level_north_clock_rpt_tap_3/i -location [list $x $y]
...
set tap_pins_list [create_tap_groups $tap_groups_list ]
insert_taps $tap_pins_list level_south_clock_tap 100 
...
set prefix "level_south_clock_rpt_tap_0"
set driver [get_pins level1_tap_t60/o]
set rcv    [get_pins level_south_clock_tap_ck00/i]
set x      [get_db $rcv .location.x]
set y      [get_db $driver .location.y]
eco_add_repeater -cells F6UNAA_LPDSINVGT5X96 -name "$prefix"     -new_net_name "${prefix}_net"   -pins [get_db $rcv .name] -location [list $x $y]
eco_add_repeater -cells F6UNAA_LPDSINVG3X48  -name "${prefix}_0" -new_net_name "${prefix}_0_net" -pins [get_db $rcv .name] -location [list $x $y]


set prefix "level_south_clock_rpt_tap_1"
set driver [get_pins level1_tap_t62/o]
set rcv    [get_pins level_south_clock_tap_ck01/i]
set x      [get_db $rcv .location.x]
set y      [get_db $driver .location.y]
eco_add_repeater -cells F6UNAA_LPDSINVGT5X96 -name "$prefix"     -new_net_name "${prefix}_net"   -pins [get_db $rcv .name] -location [list $x $y]
eco_add_repeater -cells F6UNAA_LPDSINVG3X48  -name "${prefix}_0" -new_net_name "${prefix}_0_net" -pins [get_db $rcv .name] -location [list $x $y]

set prefix "level_south_clock_rpt_tap_2"
set driver [get_pins level1_tap_t64/o]
set rcv    [get_pins level_south_clock_tap_ck02/i]
set x      [get_db $rcv .location.x]
set y      [get_db $driver .location.y]
eco_add_repeater -cells F6UNAA_LPDSINVGT5X96 -name "$prefix"     -new_net_name "${prefix}_net"   -pins [get_db $rcv .name] -location [list $x $y]
eco_add_repeater -cells F6UNAA_LPDSINVG3X48  -name "${prefix}_0" -new_net_name "${prefix}_0_net" -pins [get_db $rcv .name] -location [list $x $y]

set prefix "level_south_clock_rpt_tap_3"
set driver [get_pins level1_tap_t66/o]
set rcv    [get_pins level_south_clock_tap_ck03/i]
set x      [get_db $rcv .location.x]
set y      [get_db $driver .location.y]
eco_add_repeater -cells F6UNAA_LPDSINVGT5X96 -name "$prefix"     -new_net_name "${prefix}_net"   -pins [get_db $rcv .name] -location [list $x $y]
eco_add_repeater -cells F6UNAA_LPDSINVG3X48  -name "${prefix}_0" -new_net_name "${prefix}_0_net" -pins [get_db $rcv .name] -location [list $x $y]
...
be_legalize_super_inv [get_db [get_cells level*clock*tap*] .name] true 400
...
# block_all_horizontal $hier_cells
set tap_pins_list [create_tap_groups $tap_groups_list ]
insert_taps $tap_pins_list tree_source 53 true
remove_my_blockages
...
#
## C1
#set inpins_list [list level0_tap_*_t01/i \
#                      level0_tap_*_t21/i \
#                      level0_tap_*_t41/i \
#                      level0_tap_*_t61/i]
#set_db [get_nets -of [get_pins $inpins_list]] .dont_touch false
#set cells1 [htree_add_useful_skew -inpins_list $inpins_list -new_cell_name level0_c1_skew_tap -dist_bw_pairs 0 -base_cell F6UNAA_LPDSINVGT5X96 -num_of_cells 1 -dist_load 20  -dist_bw_invs 40 -no_legalize]
#
## C2-3
#set inpins_list [list level1_tap_t02/i \
#                      level1_tap_t22/i \
#                      level1_tap_t42/i \
#                      level1_tap_t62/i]
#set_db [get_nets -of [get_pins $inpins_list]] .dont_touch false
#set cells2 [htree_add_useful_skew -inpins_list $inpins_list -new_cell_name level1_c2_skew_tap -dist_bw_pairs 0 -base_cell F6UNAA_LPDSINVGT5X96 -num_of_cells 1 -dist_load 20 -dist_bw_invs 40 -no_legalize]
#
## C3
#set inpins_list [list level0_tap_*_t03/i \
#                      level0_tap_*_t23/i \
#                      level0_tap_*_t43/i \
#                      level0_tap_*_t63/i]
#set_db [get_nets -of [get_pins $inpins_list]] .dont_touch false
#set cells3 [htree_add_useful_skew -inpins_list $inpins_list -new_cell_name level0_c3_skew_tap -dist_bw_pairs 0 -base_cell F6UNAA_LPDSINVGT5X96 -num_of_cells 1 -dist_load 20 -dist_bw_invs 40 -no_legalize]
#
## C4-5-6-7
#set inpins_list [list level2_tap*_t04/i \
#                      level2_tap*_t24/i ]
#set_db [get_nets -of [get_pins $inpins_list]] .dont_touch false
#set cells4 [htree_add_useful_skew -inpins_list $inpins_list -new_cell_name level2_c4_skew_tap -dist_bw_pairs 0 -base_cell F6UNAA_LPDSINVGT5X96 -num_of_cells 1 -dist_load 10 -dist_bw_invs 20 -no_legalize]
#
## C4-5
#set inpins_list [list level1_tap_t04/i \
#                      level1_tap_t24/i \
#                      level1_tap_t44/i \
#                      level1_tap_t64/i]
#set_db [get_nets -of [get_pins $inpins_list]] .dont_touch false
#set cells4 [htree_add_useful_skew -inpins_list $inpins_list -new_cell_name level1_c4_skew_tap -dist_bw_pairs 0 -base_cell F6UNAA_LPDSINVGT5X96 -num_of_cells 1 -dist_load 20 -dist_bw_invs 40 -no_legalize]
#
## C5
#set inpins_list [list level0_tap_*_t05/i \
#                      level0_tap_*_t25/i \
#                      level0_tap_*_t45/i \
#                      level0_tap_*_t65/i]
#set_db [get_nets -of [get_pins $inpins_list]] .dont_touch false
#set cells2 [htree_add_useful_skew -inpins_list $inpins_list -new_cell_name level0_c5_skew_tap -dist_bw_pairs 300 -base_cell F6UNAA_LPDSINVGT5X96 -num_of_cells 1 -dist_load 20 -dist_bw_invs 40 -no_legalize]
#
## C6-7
#set inpins_list [list level1_tap_t06/i \
#                      level1_tap_t26/i \
#                      level1_tap_t46/i \
#                      level1_tap_t66/i]
#set_db [get_nets -of [get_pins $inpins_list]] .dont_touch false
#set cells4 [htree_add_useful_skew -inpins_list $inpins_list -new_cell_name level1_c6_skew_tap -dist_bw_pairs 0 -base_cell F6UNAA_LPDSINVGT5X96 -num_of_cells 1 -dist_load 20 -dist_bw_invs 40 -no_legalize]
#
## C7
#set inpins_list [list level0_tap_*_t07/i \
#                      level0_tap_*_t27/i \
#                      level0_tap_*_t47/i \
#                      level0_tap_*_t67/i]
#set_db [get_nets -of [get_pins $inpins_list]] .dont_touch false
#set cells4 [htree_add_useful_skew -inpins_list $inpins_list -new_cell_name level0_c7_skew_tap -dist_bw_pairs 0 -base_cell F6UNAA_LPDSINVGT5X96 -num_of_cells 1 -dist_load 20 -dist_bw_invs 40 -no_legalize]
##
########################
#### ADD USEFUL SKEW ###
########################
...
#                      level0_tap_*_t61/i]
#set_db [get_nets -of [get_pins $inpins_list]] .dont_touch false
#set cells1 [htree_add_useful_skew -inpins_list $inpins_list -new_cell_name level0_c1_skew_tap -dist_bw_pairs 0 -base_cell F6UNAA_LPDSINVG3X48 -num_of_cells 1 -dist_load 20  -dist_bw_invs 40 -no_legalize]
#
## C2-3
#set inpins_list [list level1_tap_t02/i \
#                      level1_tap_t22/i \
...
#                      level1_tap_t62/i]
#set_db [get_nets -of [get_pins $inpins_list]] .dont_touch false
#set cells2 [htree_add_useful_skew -inpins_list $inpins_list -new_cell_name level1_c2_skew_tap -dist_bw_pairs 0 -base_cell F6UNAA_LPDSINVG3X48 -num_of_cells 1 -dist_load 20 -dist_bw_invs 40 -no_legalize]
#
## C3
#set inpins_list [list level0_tap_*_t03/i \
#                      level0_tap_*_t23/i \
...
#                      level0_tap_*_t63/i]
#set_db [get_nets -of [get_pins $inpins_list]] .dont_touch false
#set cells3 [htree_add_useful_skew -inpins_list $inpins_list -new_cell_name level0_c3_skew_tap -dist_bw_pairs 0 -base_cell F6UNAA_LPDSINVG3X48 -num_of_cells 1 -dist_load 20 -dist_bw_invs 40 -no_legalize]
#
## C4-5-6-7
#set inpins_list [list level2_tap*_t04/i \
#                      level2_tap*_t24/i ]
#set_db [get_nets -of [get_pins $inpins_list]] .dont_touch false
#set cells4 [htree_add_useful_skew -inpins_list $inpins_list -new_cell_name level2_c4_skew_tap -dist_bw_pairs 0 -base_cell F6UNAA_LPDSINVG3X48 -num_of_cells 1 -dist_load 10 -dist_bw_invs 20 -no_legalize]
#
## C4-5
#set inpins_list [list level1_tap_t04/i \
#                      level1_tap_t24/i \
...
#                      level1_tap_t64/i]
#set_db [get_nets -of [get_pins $inpins_list]] .dont_touch false
#set cells4 [htree_add_useful_skew -inpins_list $inpins_list -new_cell_name level1_c4_skew_tap -dist_bw_pairs 0 -base_cell F6UNAA_LPDSINVG3X48 -num_of_cells 1 -dist_load 20 -dist_bw_invs 40 -no_legalize]
#
## C5
#set inpins_list [list level0_tap_*_t05/i \
#                      level0_tap_*_t25/i \
...
#                      level0_tap_*_t65/i]
#set_db [get_nets -of [get_pins $inpins_list]] .dont_touch false
#set cells2 [htree_add_useful_skew -inpins_list $inpins_list -new_cell_name level0_c5_skew_tap -dist_bw_pairs 300 -base_cell F6UNAA_LPDSINVG3X48 -num_of_cells 1 -dist_load 20 -dist_bw_invs 40 -no_legalize]
#
## C6-7
#set inpins_list [list level1_tap_t06/i \
#                      level1_tap_t26/i \
...
#                      level1_tap_t66/i]
#set_db [get_nets -of [get_pins $inpins_list]] .dont_touch false
#set cells4 [htree_add_useful_skew -inpins_list $inpins_list -new_cell_name level1_c6_skew_tap -dist_bw_pairs 0 -base_cell F6UNAA_LPDSINVG3X48 -num_of_cells 1 -dist_load 20 -dist_bw_invs 40 -no_legalize]
#
## C7
#set inpins_list [list level0_tap_*_t07/i \
#                      level0_tap_*_t27/i \
...
#                      level0_tap_*_t67/i]
#set_db [get_nets -of [get_pins $inpins_list]] .dont_touch false
#set cells4 [htree_add_useful_skew -inpins_list $inpins_list -new_cell_name level0_c7_skew_tap -dist_bw_pairs 0 -base_cell F6UNAA_LPDSINVG3X48 -num_of_cells 1 -dist_load 20 -dist_bw_invs 40 -no_legalize]
#
#
#set cells [get_cells *level*skew_tap*]
#be_legalize_super_inv $cells 100
#set cells [get_cells *level*skew_tap*]
#quad_clock_route $cells
#check_super_inv_drc $cells

#set bad_nets [get_db -unique [get_db [get_db markers ] .objects.]]
#delete_routes -net $bad_nets
#quad_clock_route [get_cells -of [get_db [get_pins -of $bad_nets] -if .direction==out]]
...
#be_build_x96_vl   [get_cells [get_db $clock_cells -if .base_cell==*T5X96*]]  false
#be_build_x320t_vl [get_cells [get_db $clock_cells -if .base_cell==*R7X320*]] false
...
proc remove_clock_shorts { net } {
  ...
  set clock_nets_wires [get_db [get_nets $clock_nets] .wires]
  set clock_nets_vias  [get_db [get_nets $clock_nets] .vias]
