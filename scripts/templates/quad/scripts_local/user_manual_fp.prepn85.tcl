...
set poly {{9876.048 8850.24} {0 8850.24} {0 1088.64} {786.828 1088.64} {786.828 0} {9821.784 0} {9821.784 231.84} \
          {9876.048 231.84} {9876.048 4203.36} {9821.784 4203.36} {9821.784 4586.40} {9876.048 4586.40}}
...
source scripts_local/create_blackboxes_w_hips.tcl -e -v 

#####################
# Update fillers size
set middle_notch_h  [expr 38*10.08] ; # 383.04
set middle_notch_w  [expr 5*$xMul]
set filler_w        [expr 7*$xMul]
set middle_notch_ur {9876.048 4586.40}
set die_ur          $tr
...
set ystart [expr [lindex $quad_bbox 3] - [expr 3*10.08]]
...
set orig_ystart $ystart
set xstart $xstart
set ystart [expr [get_db [get_cells i_pseudo_quad_r6_c0_i_nfi_mcu_top] .bbox.ll.y] - $h_channel(7)*$yMul]

set nfi_ul_index  [list 7 0]
set rows 1
set cols 8
...
place_inst i_pseudo_quad_r0_c0_i_w_filler  [list 0 [lindex [lindex [get_db [get_cells i_pseudo_quad_r6_c0_i_cbue_top] .location] 0] 1] ] r0
place_inst i_pseudo_quad_r0_c0_i_s_filler  [list [get_db [get_cells i_pseudo_quad_r7_c0_i_nfi_mcu_top] .bbox.ll.x] 0] r0
place_inst i_pseudo_quad_r0_c0_i_n_filler  [list $xstart [expr $orig_ystart + 1*$yMul]] r0
place_inst i_pseudo_quad_r0_c0_i_se_filler [list [expr [get_db [get_cells i_pseudo_quad_r0_c7_i_nfi_mcu_top] .bbox.ur.x]] [expr [get_db [get_cells i_pseudo_quad_r0_c0_i_s_filler] .bbox.ur.y] - 0*$yMul] ] r0
place_inst i_pseudo_quad_r0_c0_i_ne_filler [list [expr [get_db [get_cells i_pseudo_quad_r0_c7_i_nfi_mcu_top] .bbox.ur.x]] [get_db [get_db insts i_pseudo_quad_r0_c0_i_se_filler] .bbox.ur.y] ] r0


place_inst i_pseudo_quad_r0_c0_i_icovlb {4775.232 4206.288} r0 
place_inst i_pseudo_quad_r0_c0_i_icovlc {4775.232 4435.200} r0 

delete_obj [get_cells i_pseudo_quad_r0_c0_i_tcu_top]
