foreach check__ {setup hold} {
	...
	report_timing 		     -delay_type $delay_type -physical -include_hierarchical_pins -slack_lesser_than 0 -max_paths 10000 -derate -crosstalk_delta  -capacitance -transition_time -nosplit -nets -input_pins -path_type full_clock_expanded  -pba_mode exhaustive > $REPORTS_DIR/${check__}_all.rpt
	report_timing -group reg2reg -delay_type $delay_type -physical -include_hierarchical_pins -slack_lesser_than 0 -max_paths 10000 -derate -crosstalk_delta  -capacitance -transition_time -nosplit -nets -input_pins -path_type full_clock_expanded  -pba_mode exhaustive > $REPORTS_DIR/${check__}_reg2reg.rpt
	report_timing -group in2reg  -delay_type $delay_type -physical -include_hierarchical_pins -slack_lesser_than 0 -max_paths 10000 -derate -crosstalk_delta  -capacitance -transition_time -nosplit -nets -input_pins -path_type full_clock_expanded  -pba_mode exhaustive > $REPORTS_DIR/${check__}_in2reg.rpt
	report_timing -group reg2out -delay_type $delay_type -physical -include_hierarchical_pins -slack_lesser_than 0 -max_paths 10000 -derate -crosstalk_delta  -capacitance -transition_time -nosplit -nets -input_pins -path_type full_clock_expanded  -pba_mode exhaustive > $REPORTS_DIR/${check__}_reg2out.rpt
	report_timing -group in2out  -delay_type $delay_type -physical -include_hierarchical_pins -slack_lesser_than 0 -max_paths 10000 -derate -crosstalk_delta  -capacitance -transition_time -nosplit -nets -input_pins -path_type full_clock_expanded  -pba_mode exhaustive > $REPORTS_DIR/${check__}_in2out.rpt
...
report_qor -pba_mode exhaustive -summary > $REPORTS_DIR/report_qor.rpt
...
report_timing -crosstalk_delta -slack_lesser_than 0.0 -pba_mode exhaustive -delay min_max -nosplit -input -net  > $REPORTS_DIR/${DESIGN_NAME}_report_timing_pba.report
